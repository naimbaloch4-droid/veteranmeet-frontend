...
const veteranNavItems = [
  ...
  {
    name: 'Connections',
    href: '/veteran/connections',
    icon: Users,
  },
  {
    name: 'Messages',
    href: '/veteran/messages',
    icon: Bell,
  },
  {
    name: 'Resources',
  ...
  {
    name: 'Profile',
    href: '/veteran/profile',
    icon: UserCircle,
  },
];

export default function VeteranLayout({
  children,
}: {
        ...
        <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 shadow-2xl transform ${
          ...
          <div className="flex flex-col h-screen">
            ...
            <div className="flex items-center justify-center h-20 px-4 bg-gray-950 border-b border-gray-800">
              <Link href="/veteran/dashboard" className="flex items-center space-x-3">
